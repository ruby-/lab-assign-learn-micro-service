...
class Client(Iface):
    ...
    def sendMobileMSG(self, mobile, msg):
        ...
        Parameters:
         ...
         - msg
        """
        self.send_sendMobileMSG(mobile, msg)
        return self.recv_sendMobileMSG()

    def send_sendMobileMSG(self, mobile, msg):
        self._oprot.writeMessageBegin('sendMobileMSG', TMessageType.CALL, self._seqid)
        args = sendMobileMSG_args()
        args.mobile = mobile
        args.msg = msg
    ...
    def recv_sendMobileMSG(self):
        ...
        if mtype == TMessageType.EXCEPTION:
            ...
            raise x
        result = sendMobileMSG_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "sendMobileMSG failed: unknown result")
    ...
    def sendEmailMessage(self, email, msg):
        ...
        Parameters:
         ...
         - msg
        """
        self.send_sendEmailMessage(email, msg)
        return self.recv_sendEmailMessage()

    def send_sendEmailMessage(self, email, msg):
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap = {}
        self._processMap["sendMobileMSG"] = Processor.process_sendMobileMSG
    ...
    def process_sendMobileMSG(self, seqid, iprot, oprot):
        args = sendMobileMSG_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = sendMobileMSG_result()
        try:
            result.success = self._handler.sendMobileMSG(args.mobile, args.msg)
        ...
        oprot.writeMessageBegin("sendMobileMSG", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
    ...
    def process_sendEmailMessage(self, seqid, iprot, oprot):
        ...
        result = sendEmailMessage_result()
        try:
            result.success = self._handler.sendEmailMessage(args.email, args.msg)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
...
class sendMobileMSG_args(object):
    """
    Attributes:
     - mobile
     - msg
    ...
    def __init__(self, mobile=None, msg=None,):
        self.mobile = mobile
        self.msg = msg
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            ...
            return
        oprot.writeStructBegin('sendMobileMSG_args')
...
all_structs.append(sendMobileMSG_args)
sendMobileMSG_args.thrift_spec = (
    None,  # 0
...
class sendMobileMSG_result(object):
    """
    Attributes:
     - success
    """
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('sendMobileMSG_result')
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(sendMobileMSG_result)
sendMobileMSG_result.thrift_spec = (
...
class sendEmailMessage_args(object):
    ...
    def __init__(self, email=None, msg=None,):
        self.email = email
        self.msg = msg
